 ...
 * <p>{@link MeasurementD} is the supporting class for measurements with values
 * of type <code>double</code>.</p>
 * <p>If you want to use <code>float</code> values then use
 * {@link MeasurementF}.</p>*/
public class MeasurementD extends AbstractMeasurement<MeasurementDListener>{
	private double value;

	/** Construct a measurement with the specified value and unit.
	 * @param value the initial value of the measurement
	 * @param unit the measurement unit*/
	public MeasurementD(double value, Unit unit) {
		super (unit);
		this.value = value;
	}
	...
	public void setValue (double newValue, Unit otherUnit) {
		double siValue = otherUnit.convertToSIBase(newValue);
